...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3442&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-pool-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-pool` can be installed with `conda`:
...
```
mamba install r-pool
```

It is possible to list all of the versions of `r-pool` available on your platform with `conda`:
...
```
mamba search r-pool --channel conda-forge
```
...
mamba repoquery search r-pool --channel conda-forge

# List packages depending on `r-pool`:
mamba repoquery whoneeds r-pool --channel conda-forge

# List dependencies of `r-pool`:
mamba repoquery depends r-pool --channel conda-forge
```
